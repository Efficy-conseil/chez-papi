...
- Une réponse mentionnant explicitement un devis signé, accepté ou validé, sans répéter le nom, le téléphone ni la date de prestation, peut exceptionnellement enrichir une demande sans email uniquement si elle mentionne au moins 100 convives et qu’il existe une seule prestation au statut `Événement confirmé` dans les 14 jours suivant la réception. Zéro ou plusieurs candidates interdisent tout rattachement automatique. Cette règle de dernier recours ne remplace jamais une adresse déjà renseignée.
