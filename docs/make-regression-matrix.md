...
| E22 | `evenementiel@maisonleydier.fr` retourne un devis signé pour 190 convives sans répéter Rossella ni le 05/09/2026 ; la demande Voxist confirmée, imminente et sans email est la seule candidate dans les 14 jours | Rattachement à la demande Rossella, conservation du statut et du canal, enrichissement de l’email vide, mise à jour des convives et du dernier message, puis `Historique_Email`. Avec zéro ou plusieurs événements confirmés imminents sans email, aucune ligne n’est modifiée et le mail reste à vérifier | Backend + automatique + essai Make |
